...
- [[Unit Testing and Test-Driven Development]]: Mocking is a technique used in unit testing to isolate and test individual [[Python Functions]] or classes.
- [[Python Functions]]: Mocks are used to substitute for other [[Python Functions]] or objects.
